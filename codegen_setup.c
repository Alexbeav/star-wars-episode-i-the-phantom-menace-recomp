...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Star Wars Episode I: The Phantom Menace",
    .project_root_env = "STAR_WARS_EPISODE_I_THE_PHANTOM_MENACE_PROJECT_ROOT",
    .build_dir_env = "STAR_WARS_EPISODE_I_THE_PHANTOM_MENACE_BUILD_DIR",
    .force_setup_env = "STAR_WARS_EPISODE_I_THE_PHANTOM_MENACE_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLES_020.34_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Star_Wars_Episode_I__The_Phantom_Menace_Recompiled",
    .prepare_note =
